...
{/// <summary>
 /// 特殊疾病认定信息查询
 /// </summary>
    public class IdentificationSpecialQueryDto : IniDto
    {
        public List<PO_RDXX> PO_RDXXs { get; set; }
    }



    public class PO_RDXXRow
    {
        public PO_RDXX Row { get; set; }
    }
    public class PO_RDXX
    {/// <summary>
     /// 认定业务流水号
     /// </summary>
        ...
        public List<PO_JBXX>  PO_JBXXs { get; set; }
    ...
    /// 疾病信息单数
    /// </summary>
    public class PO_JBXXRow
    {
        public PO_JBXX Row { get; set; }
    }

    public class PO_JBXX
    {/// <summary>
     /// >特殊疾病编号
     /// </summary>
